...
| `+` | `+` |
| [debian-iso-builder-remix-openbox](https://samwhelp.github.io/debian-iso-builder-remix-openbox/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-remix-openbox) |
| `=` | `=` |
| [debian-iso-builder-respin-openbox](https://samwhelp.github.io/debian-iso-builder-respin-openbox/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-respin-openbox) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-respin-openbox/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-respin-openbox/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-respin-openbox/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-respin-openbox](https://github.com/samwhelp/debian-iso-builder-respin-openbox)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-respin-openbox.git
```


> change dir to `debian-iso-builder-respin-openbox`

``` sh
cd debian-iso-builder-respin-openbox
```
...
> The resulting ISO file will be placed on `debian-iso-builder-remix-openbox/dist`
